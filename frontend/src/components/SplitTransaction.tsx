 ...
 *
 * This is the panel only — splitting is reached from the row's ⋯ menu, which
 * owns the trigger, the positioning context and dismissal. Its queries run on
 * mount, so a page of hundreds of rows costs nothing until one is opened.
 */
